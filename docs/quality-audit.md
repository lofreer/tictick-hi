...
- 仍缺设备指纹、可信设备、地理位置、风险评分、强制下线、MFA 和外部告警。
- 审计事件仍写入主库，不提供外部不可篡改证明、签名、独立归档或告警。
