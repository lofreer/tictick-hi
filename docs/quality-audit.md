...
- 不新增 claim 成功率、处理耗时、stale worker、exchange backoff、fetch-lock skip、catalog freshness 或 notification provider 可达性 readiness。
- 不新增 Prometheus 指标、SLO、告警规则、外部 uptime monitor 或 Docker Compose 默认 healthcheck。
