...
- 当前只有 offset 分页，没有按异常类型、时间范围或异常严重程度过滤。
- 项目整体仍是 `scaffold`，阶段 1 研究核心仍未达到 usable。
