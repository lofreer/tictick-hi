...
- `go test ./internal/web/api -run 'TestDisablingOperatorRevokesSessions|TestOperatorCannotDisableSelf|TestOperatorEnableDisableStoreFailureAudited' -count=1` 通过。
