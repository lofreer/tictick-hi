...
func TestAPIMethodNotAllowedContracts(t *testing.T) {
	...
	cases := []struct {
		...
		{method: http.MethodPost, path: "/api/market/candle-gaps", allow: http.MethodGet},
		{method: http.MethodPost, path: "/api/market/candle-invalid-issues", allow: http.MethodGet},
		{method: http.MethodGet, path: "/api/market/candle-gaps/repair", allow: http.MethodPost},
		{method: http.MethodGet, path: "/api/market/candle-gaps/repair-batch", allow: http.MethodPost},
		{method: http.MethodGet, path: "/api/market/candle-invalid-issues/repair", allow: http.MethodPost},
		{method: http.MethodPost, path: "/api/market/instruments", allow: http.MethodGet},
		{method: http.MethodPost, path: "/api/market/instruments/status", allow: http.MethodGet},
		{method: http.MethodGet, path: "/api/market/instruments/sync", allow: http.MethodPost},
		{method: http.MethodPut, path: "/api/data/tasks", allow: http.MethodGet + ", " + http.MethodPost},
		{method: http.MethodPatch, path: "/api/data/tasks/dst_1", allow: http.MethodGet + ", " + http.MethodDelete},
		...
		{method: http.MethodPost, path: "/api/data/tasks/dst_1/invalid-issues", allow: http.MethodGet},
		{method: http.MethodGet, path: "/api/data/tasks/dst_1/repair-gaps", allow: http.MethodPost},
		{method: http.MethodGet, path: "/api/data/tasks/dst_1/repair-invalid-issues", allow: http.MethodPost},
		{method: http.MethodGet, path: "/api/data/tasks/dst_1/repair-gap", allow: http.MethodPost},
		{method: http.MethodGet, path: "/api/auth/password", allow: http.MethodPost},
		...
		{method: http.MethodPost, path: "/api/system/audit-events/page", allow: http.MethodGet},
		{method: http.MethodPost, path: "/api/system/audit-events/export", allow: http.MethodGet},
		{method: http.MethodPost, path: "/api/system/audit-events/hash-chain/verify", allow: http.MethodGet},
		...
		{method: http.MethodGet, path: "/api/system/operators/op_admin/password", allow: http.MethodPost},
		{method: http.MethodPost, path: "/api/system/operators/op_admin/sessions", allow: http.MethodGet},
		{method: http.MethodGet, path: "/api/system/operators/op_admin/sessions/session_1", allow: http.MethodDelete},
