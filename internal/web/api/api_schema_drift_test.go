...
func TestFrontendAPIRequestTypesMatchContractSchemas(t *testing.T) {
	...
	for _, item := range []struct {
		...
		{"RepairMarketCandleGapsRequest", "RepairMarketCandleGapsRequest"},
		{"RepairMarketCandleInvalidIssuesRequest", "RepairMarketCandleInvalidIssuesRequest"},
...
func TestFrontendAPIResponseTypesMatchContractFields(t *testing.T) {
	...
	for _, item := range []struct {
		...
		{"DataSyncInvalidSummary", "DataSyncInvalidSummary"},
		{"DataSyncGapList", "DataSyncGapList"},
		{"DataSyncInvalidIssueList", "DataSyncInvalidIssueList"},
		{"DataSyncGapRepairResult", "DataSyncGapRepairResult"},
		{"MarketCandleGapScan", "MarketCandleGapScan"},
		{"MarketCandleInvalidIssueScan", "MarketCandleInvalidIssueScan"},
