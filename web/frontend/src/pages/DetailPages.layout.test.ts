...
describe("strategy detail page layout contract", () => {
  it("keeps trading detail chart above summary and tabbed lists", () => {
    ...
    expect(detailChartStyles).toContain("--kline-chart-plot-height: clamp(720px, 78vh, 900px);");
    expect(detailChartStyles).toContain("--kline-chart-padding-left: 22px;");
    ...
    expect(detailChartStyles).toContain("--kline-chart-plot-height: 600px;");
