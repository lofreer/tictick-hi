...
describe("ResearchPage chart layout contract", () => {
  it("keeps the chart in a fixed flex viewport below the sync list", () => {
    ...
    expect(tasksStyle).toContain("max-height: clamp(168px, 21vh, 210px);");
    ...
    expect(toolbarStyle).toContain("padding: 8px 10px;");
    expect(toolbarStyle).toContain("overflow: hidden;");
    expect(controlsStyle).toContain("display: grid;");
    expect(controlsStyle).toContain("grid-template-columns: 102px 112px 28px 58px max-content;");
  ...
  it("keeps a readable chart viewport when the app header stacks on narrow desktop widths", () => {
    ...
    expect(pageStyles).toContain("grid-template-columns: 102px 112px 28px 58px max-content;");
    expect(pageStyles).toContain("width: 112px;");
    expect(pageStyles).toContain("width: 108px;");
    expect(pageStyles).toContain("width: 104px;");
    expect(pageStyles).toContain("width: 26px;");
