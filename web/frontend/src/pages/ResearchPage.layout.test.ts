...
describe("ResearchPage chart layout contract", () => {
  ...
  it("lets the chart renderer fill the external viewport without gutter shrinkage", () => {
    ...
    expect(lightweightStyle).toContain("max-block-size: 100%;");
    expect(lightweightStyle).toContain("max-height: 100%;");
    expect(lightweightStyle).toContain("max-inline-size: 100%;");
    ...
    expect(lightweightStyle).not.toContain("!important");
    expect(cssDeclarations(lightweightStyle)).not.toContain("height: 100%");
    expect(cssDeclarations(lightweightStyle)).not.toContain("width: 100%");
    expect(cssDeclarations(lightweightStyle)).not.toContain("block-size: 100%");
    expect(cssDeclarations(lightweightStyle)).not.toContain("inline-size: 100%");
