...
require_contains "$RESEARCH_CSS" "grid-template-columns: 128px clamp(180px, 18vw, 300px) 84px auto;"
require_contains "$RESEARCH_CSS" "width: fit-content;"
require_contains "$RESEARCH_CSS" ".research-toolbar-status"
require_contains "$RESEARCH_CSS" ".research-current-source"
require_contains "$RESEARCH_CSS" "padding: 10px 12px 9px;"
...
require_block_contains "$RESEARCH_CSS" ".research-chart-viewport" "height: calc(var(--research-chart-viewport-height) - var(--research-chart-padding-top) - var(--research-chart-padding-bottom)) !important;"
require_block_contains "$RESEARCH_CSS" ".research-chart-viewport" "max-height: calc(var(--research-chart-viewport-height) - var(--research-chart-padding-top) - var(--research-chart-padding-bottom)) !important;"
...
require_contains "$RESEARCH_CSS" "--research-chart-viewport-height: clamp(720px, 72vh, 920px);"
require_contains "$RESEARCH_CSS" "--research-chart-viewport-height: clamp(720px, 72dvh, 920px);"
require_contains "$RESEARCH_CSS" "--research-chart-viewport-height: clamp(640px, 62vh, 760px);"
require_contains "$RESEARCH_CSS" "--research-chart-viewport-height: clamp(640px, 62dvh, 760px);"
require_contains "$RESEARCH_CSS" "grid-template-columns: 112px minmax(160px, 240px) 76px auto;"
