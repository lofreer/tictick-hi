...
require_contains "$THEME_TOKENS" "export const chartAxisFontSize = 18;"
require_contains "$THEME_TOKENS" "desktop: 92,"
require_contains "$THEME_TOKENS" "narrowDesktop: 90,"
require_contains "$THEME_TOKENS" "mobile: 86,"
