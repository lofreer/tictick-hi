...
require_contains "$RESEARCH_CSS" "padding: 10px 14px 9px;"
...
require_contains "$RESEARCH_CSS" "--research-chart-viewport-height: clamp(680px, 74vh, 900px);"
require_contains "$RESEARCH_CSS" "--research-chart-viewport-height: clamp(680px, 74dvh, 900px);"
require_contains "$RESEARCH_CSS" "--research-chart-viewport-height: clamp(620px, 66vh, 760px);"
require_contains "$RESEARCH_CSS" "--research-chart-viewport-height: clamp(620px, 66dvh, 760px);"
