...
require_contains "$RESEARCH_CSS" "max-height: min(190px, 18vh);"
require_contains "$RESEARCH_CSS" "max-height: min(190px, 18dvh);"
require_contains "$RESEARCH_CSS" "overflow: auto;"
require_contains "$RESEARCH_CSS" ".research-chart-panel"
require_contains "$RESEARCH_CSS" "--research-chart-plot-height:"
require_contains "$RESEARCH_CSS" "--research-chart-body-height:"
...
require_contains "$RESEARCH_CSS" "display: flex;"
require_contains "$RESEARCH_CSS" "flex-wrap: nowrap;"
require_contains "$RESEARCH_CSS" "width: auto;"
...
require_contains "$RESEARCH_CSS" "padding: 8px 12px;"
...
require_contains "$RESEARCH_CSS" "flex: 0 0 var(--research-chart-body-height);"
require_contains "$RESEARCH_CSS" "height: var(--research-chart-body-height) !important;"
require_contains "$RESEARCH_CSS" "max-height: var(--research-chart-body-height) !important;"
require_block_contains "$RESEARCH_CSS" ".research-chart-body" "var(--research-chart-padding-right)"
require_block_contains "$RESEARCH_CSS" ".research-chart-body" "var(--research-chart-padding-left)"
...
require_block_contains "$RESEARCH_CSS" ".research-chart-viewport" "height: var(--research-chart-plot-height) !important;"
require_block_contains "$RESEARCH_CSS" ".research-chart-viewport" "max-height: var(--research-chart-plot-height) !important;"
...
require_contains "$RESEARCH_CSS" "--research-chart-plot-height: clamp(620px, calc(100vh - 250px), 760px);"
require_contains "$RESEARCH_CSS" "--research-chart-plot-height: clamp(620px, calc(100dvh - 250px), 760px);"
require_contains "$RESEARCH_CSS" "--research-chart-plot-height: clamp(600px, calc(100vh - 290px), 720px);"
require_contains "$RESEARCH_CSS" "--research-chart-plot-height: clamp(600px, calc(100dvh - 290px), 720px);"
require_contains "$RESEARCH_CSS" "--research-chart-plot-height: clamp(500px, calc(100vh - 240px), 620px);"
require_contains "$RESEARCH_CSS" "--research-chart-padding-left: 16px;"
require_contains "$RESEARCH_CSS" "--research-chart-padding-right: 4px;"
require_contains "$RESEARCH_CSS" "--research-chart-padding-left: 12px;"
require_contains "$RESEARCH_CSS" "--research-chart-padding-right: 3px;"
require_contains "$RESEARCH_CSS" "--research-chart-padding-left: 8px;"
require_contains "$RESEARCH_CSS" "--research-chart-padding-right: 2px;"
require_contains "$RESEARCH_CSS" "width: clamp(168px, 12vw, 210px);"
require_contains "$RESEARCH_CSS" "flex-basis: min(210px, 28vw);"
require_contains "$RESEARCH_CSS" "flex: 0 0 180px;"
require_contains "$RESEARCH_CSS" "max-width: 220px;"
