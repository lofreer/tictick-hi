...
require_block_contains "$RESEARCH_CSS" ".research-source-controls" "grid-template-columns: 112px 156px 28px 68px max-content;"
...
require_block_contains "$RESEARCH_CSS" ".research-toolbar" "grid-template-columns: auto minmax(0, 1fr);"
...
require_contains "$RESEARCH_CSS" "--kline-chart-plot-height: clamp(620px, 62vh, 760px);"
...
require_contains "$RESEARCH_CSS" "--kline-chart-padding-right: 12px;"
require_contains "$RESEARCH_CSS" "--kline-chart-padding-right: 10px;"
require_contains "$RESEARCH_CSS" "width: 156px;"
require_contains "$RESEARCH_CSS" "width: 148px;"
require_contains "$RESEARCH_CSS" "width: 142px;"
require_contains "$RESEARCH_CSS" "max-width: min(320px, 36vw);"
