...
require_block_contains "$RESEARCH_CSS" ".research-source-controls" "grid-template-columns: 90px 96px 26px 50px max-content;"
...
require_contains "$RESEARCH_CSS" "--kline-chart-plot-height: clamp(760px, 76vh, 920px);"
require_contains "$RESEARCH_CSS" "--kline-chart-plot-height: 780px;"
require_contains "$RESEARCH_CSS" "--kline-chart-plot-height: 608px;"
require_contains "$RESEARCH_CSS" "--kline-chart-padding-left: 20px;"
