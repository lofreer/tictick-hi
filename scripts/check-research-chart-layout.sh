...
require_contains "$RESEARCH_CSS" "--kline-chart-plot-height:"
require_contains "$RESEARCH_CSS" "--kline-chart-frame-height:"
...
require_block_contains "$RESEARCH_CSS" ".research-source-controls" "grid-template-columns: 128px clamp(170px, 12vw, 196px) 76px max-content;"
...
require_block_contains "$RESEARCH_CSS" ".research-toolbar" "padding: 10px 16px 9px;"
require_block_contains "$RESEARCH_CSS" ".research-toolbar-status" "justify-content: space-between;"
...
require_block_contains "$KLINE_CHART_CSS" ".kline-chart-frame" "height: var(--kline-chart-frame-height) !important;"
require_block_contains "$KLINE_CHART_CSS" ".kline-chart-frame" "max-height: var(--kline-chart-frame-height) !important;"
...
require_block_contains "$KLINE_CHART_CSS" ".kline-chart-frame__viewport" "height: var(--kline-chart-plot-height) !important;"
require_block_contains "$KLINE_CHART_CSS" ".kline-chart-frame__viewport" "max-height: var(--kline-chart-plot-height) !important;"
...
require_contains "$RESEARCH_CSS" "--kline-chart-plot-height: clamp(680px, 68vh, 820px);"
require_contains "$RESEARCH_CSS" "--kline-chart-plot-height: clamp(680px, 68dvh, 820px);"
require_contains "$RESEARCH_CSS" "--kline-chart-plot-height: clamp(640px, 66vh, 760px);"
require_contains "$RESEARCH_CSS" "--kline-chart-plot-height: clamp(640px, 66dvh, 760px);"
require_contains "$RESEARCH_CSS" "--kline-chart-plot-height: clamp(520px, 66vh, 640px);"
require_contains "$RESEARCH_CSS" "--kline-chart-padding-left: 24px;"
require_contains "$RESEARCH_CSS" "--kline-chart-padding-left: 18px;"
require_contains "$RESEARCH_CSS" "--kline-chart-padding-left: 12px;"
require_contains "$RESEARCH_CSS" "--kline-chart-padding-right: 2px;"
require_contains "$RESEARCH_CSS" "--kline-chart-padding-right: 1px;"
require_contains "$RESEARCH_CSS" "width: clamp(170px, 12vw, 196px);"
require_contains "$RESEARCH_CSS" "width: 188px;"
require_contains "$RESEARCH_CSS" "width: 176px;"
require_contains "$RESEARCH_CSS" "max-width: 240px;"
