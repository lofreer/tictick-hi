...
require_contains "$RESEARCH_CSS" "max-height: clamp(144px, 18vh, 176px);"
...
require_block_contains "$RESEARCH_CSS" ".research-source-controls" "grid-template-columns: 88px 92px 26px 48px max-content;"
...
require_block_contains "$RESEARCH_CSS" ".research-toolbar" "padding: 7px 10px;"
...
require_contains "$RESEARCH_CSS" "--kline-chart-plot-height: clamp(640px, 72vh, 820px);"
require_contains "$RESEARCH_CSS" "--kline-chart-plot-height: 720px;"
