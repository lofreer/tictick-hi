...
require_contains "$RESEARCH_CSS" "max-height: 220px;"
...
require_block_contains "$RESEARCH_CSS" ".research-source-controls" "grid-template-columns: 128px 196px 78px max-content;"
...
require_block_contains "$RESEARCH_CSS" ".research-toolbar" "grid-template-columns: minmax(0, max-content) minmax(0, 1fr);"
require_block_contains "$RESEARCH_CSS" ".research-toolbar" "padding: 10px 14px;"
require_block_contains "$RESEARCH_CSS" ".research-toolbar-status" "justify-content: flex-end;"
...
require_contains "$RESEARCH_CSS" "--kline-chart-plot-height: clamp(680px, 42vw, 720px);"
require_contains "$RESEARCH_CSS" "--kline-chart-plot-height: 640px;"
require_contains "$RESEARCH_CSS" "--kline-chart-plot-height: 520px;"
require_contains "$RESEARCH_CSS" "--kline-chart-padding-left: 14px;"
...
require_contains "$RESEARCH_CSS" "width: 196px;"
