...
require_contains "$RESEARCH_CSS" "grid-template-columns: 128px minmax(280px, 520px) 84px auto;"
...
require_contains "$RESEARCH_CSS" "grid-template-columns: 112px minmax(160px, 1fr) 76px auto;"
