...
require_contains "$RESEARCH_CSS" "--kline-chart-plot-height: clamp(680px, 72dvh, 820px);"
require_contains "$RESEARCH_CSS" "--kline-chart-plot-height: 700px;"
require_contains "$RESEARCH_CSS" "--kline-chart-plot-height: 580px;"
