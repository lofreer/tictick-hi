...
require_contains "$RESEARCH_CSS" "max-height: min(220px, 20vh);"
require_contains "$RESEARCH_CSS" "max-height: min(220px, 20dvh);"
...
require_contains "$RESEARCH_CSS" "--research-chart-plot-height: clamp(680px, 75vh, 900px);"
require_contains "$RESEARCH_CSS" "--research-chart-plot-height: clamp(680px, 75dvh, 900px);"
require_contains "$RESEARCH_CSS" "--research-chart-plot-height: clamp(620px, 68vh, 760px);"
require_contains "$RESEARCH_CSS" "--research-chart-plot-height: clamp(620px, 68dvh, 760px);"
require_contains "$RESEARCH_CSS" "--research-chart-padding-left: 22px;"
require_contains "$RESEARCH_CSS" "--research-chart-padding-right: 8px;"
require_contains "$RESEARCH_CSS" "--research-chart-padding-left: 16px;"
require_contains "$RESEARCH_CSS" "--research-chart-padding-right: 6px;"
require_contains "$RESEARCH_CSS" "--research-chart-padding-left: 12px;"
require_contains "$RESEARCH_CSS" "width: clamp(180px, 15vw, 240px);"
require_contains "$RESEARCH_CSS" "flex-basis: min(240px, 32vw);"
require_contains "$RESEARCH_CSS" "flex-basis: 100%;"
