...
require_contains "$THEME_TOKENS" "export const chartAxisFontSize = 26;"
require_contains "$THEME_TOKENS" "desktop: 122,"
require_contains "$THEME_TOKENS" "narrowDesktop: 116,"
require_contains "$THEME_TOKENS" "mobile: 102,"
...
require_contains "$ROOT_DIR/scripts/stage8-visual-smoke.mjs" "SMOKE_MAX_RIGHT_PRICE_AXIS_WIDTH, 136"
