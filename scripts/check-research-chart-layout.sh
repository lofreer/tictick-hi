...
require_contains "$THEME_TOKENS" "export const chartAxisFontSize = 22;"
require_contains "$THEME_TOKENS" "desktop: 112,"
require_contains "$THEME_TOKENS" "narrowDesktop: 108,"
require_contains "$THEME_TOKENS" "mobile: 100,"
...
require_contains "$ROOT_DIR/scripts/stage8-visual-smoke.mjs" "SMOKE_MAX_RIGHT_PRICE_AXIS_WIDTH, 124"
