...
require_contains "$THEME_TOKENS" "desktop: 102,"
require_contains "$THEME_TOKENS" "narrowDesktop: 98,"
require_contains "$THEME_TOKENS" "mobile: 90,"
...
require_contains "$ROOT_DIR/scripts/stage8-visual-smoke.mjs" "SMOKE_MAX_RIGHT_PRICE_AXIS_WIDTH, 114"
