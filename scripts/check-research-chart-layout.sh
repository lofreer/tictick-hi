...
require_contains "$RESEARCH_CSS" "--kline-chart-plot-height: clamp(620px, calc(100vh - 250px), 760px);"
require_contains "$RESEARCH_CSS" "--kline-chart-plot-height: clamp(620px, calc(100dvh - 250px), 760px);"
require_contains "$RESEARCH_CSS" "--kline-chart-plot-height: clamp(600px, calc(100vh - 290px), 720px);"
require_contains "$RESEARCH_CSS" "--kline-chart-plot-height: clamp(600px, calc(100dvh - 290px), 720px);"
require_contains "$RESEARCH_CSS" "--kline-chart-plot-height: clamp(500px, calc(100vh - 240px), 620px);"
...
require_contains "$RESEARCH_CSS" "--kline-chart-padding-right: 3px;"
require_contains "$RESEARCH_CSS" "--kline-chart-padding-left: 8px;"
