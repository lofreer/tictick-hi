...
require_block_contains "$RESEARCH_CSS" ".research-source-controls" "grid-template-columns: 100px 132px 28px 56px max-content;"
...
require_contains "$RESEARCH_CSS" "--kline-chart-plot-height: clamp(720px, 78vh, 900px);"
require_contains "$RESEARCH_CSS" "--kline-chart-plot-height: 760px;"
require_contains "$RESEARCH_CSS" "--kline-chart-plot-height: 600px;"
require_contains "$RESEARCH_CSS" "--kline-chart-padding-left: 22px;"
