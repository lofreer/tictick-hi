...
require_contains "$THEME_TOKENS" "export const chartAxisFontSize = 16;"
require_contains "$THEME_TOKENS" "desktop: 82,"
require_contains "$THEME_TOKENS" "narrowDesktop: 80,"
require_contains "$THEME_TOKENS" "mobile: 76,"
...
require_contains "$ROOT_DIR/scripts/stage8-visual-smoke.mjs" "SMOKE_MAX_RIGHT_PRICE_AXIS_WIDTH, 96"
