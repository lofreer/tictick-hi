...
require_block_contains "$RESEARCH_CSS" ".research-source-controls" "grid-template-columns: 108px 136px 28px 64px max-content;"
...
require_block_contains "$RESEARCH_CSS" ".research-toolbar" "padding: 9px 12px 10px;"
...
require_contains "$RESEARCH_CSS" "--kline-chart-plot-height: clamp(660px, 66vh, 800px);"
require_contains "$RESEARCH_CSS" "--kline-chart-plot-height: 680px;"
require_contains "$RESEARCH_CSS" "--kline-chart-plot-height: 540px;"
...
require_contains "$RESEARCH_CSS" "width: 136px;"
require_contains "$RESEARCH_CSS" "width: 132px;"
require_contains "$RESEARCH_CSS" "width: 128px;"
require_contains "$RESEARCH_CSS" "max-width: min(300px, 42vw);"
