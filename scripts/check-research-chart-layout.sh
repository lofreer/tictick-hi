...
require_block_contains "$RESEARCH_CSS" ".research-source-controls" "grid-template-columns: 122px 174px 72px max-content;"
...
require_contains "$RESEARCH_CSS" "width: 174px;"
require_contains "$RESEARCH_CSS" "width: 166px;"
require_contains "$RESEARCH_CSS" "width: 158px;"
