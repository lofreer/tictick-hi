...
require_block_contains "$RESEARCH_CSS" ".research-source-controls" "grid-template-columns: 112px 156px 68px max-content;"
...
require_block_contains "$RESEARCH_CSS" ".research-toolbar" "padding: 10px 16px 8px;"
...
require_contains "$RESEARCH_CSS" "--kline-chart-plot-height: clamp(700px, 44vw, 760px);"
require_contains "$RESEARCH_CSS" "--kline-chart-plot-height: 680px;"
require_contains "$RESEARCH_CSS" "--kline-chart-plot-height: 560px;"
...
require_contains "$RESEARCH_CSS" "--kline-chart-padding-right: 0px;"
